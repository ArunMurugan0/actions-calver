...
set_github_output "release" $NEXT_RELEASE
set_github_output "title" $NAME
set_github_output "changelog" $MESSAGE
set_github_output "draft" $DRAFT
set_github_output "pre" $PRE
